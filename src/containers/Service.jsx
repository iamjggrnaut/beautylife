        ...
        <div id='service'>
            ...
            <div className="prime-bg">
                <div className="container">
                    <p>
                        В салоне красоты и косметологии Beauty Life мы предлагаем широкий спектр услуг, которые помогут вам выглядеть и чувствовать себя великолепно. Наши профессиональные мастера используют только лучшие косметические средства и современные технологии, чтобы обеспечить вам наивысшее качество обслуживания.
                    </p>
                </div>
            </div>
